...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  const whatsappMessage = encodeURIComponent(
    `Hello 👋! I'm interested in ordering *${product.name}* (Price: KSh ${product.price.toLocaleString()}). Could you please share more details?`
  );
      ...
      <div className="flex flex-col flex-grow p-3 relative z-10">
        ...
        <div className="flex flex-col gap-2 mt-auto">
          ...
          <button
            ...
            disabled={!isInStock}
            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-semibold text-white bg-[#25D366] hover:bg-[#22c35e] disabled:bg-gray-300 disabled:cursor-not-allowed rounded-lg shadow-md hover:shadow-lg transition-all duration-300"
          >
